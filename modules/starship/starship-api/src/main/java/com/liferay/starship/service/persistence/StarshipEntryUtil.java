...
public class StarshipEntryUtil {
	 ...
	 */
	public static List<StarshipEntry> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<StarshipEntry> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchEntryException if a starship entry with the primary key could not be found
	 */
	public static StarshipEntry[] filterFindByGroupId_PrevAndNext(
			long starshipEntryId, long groupId,
			OrderByComparator<StarshipEntry> orderByComparator)
		throws com.liferay.starship.exception.NoSuchEntryException {
	 ...
	 * @throws NoSuchEntryException if a matching starship entry could not be found
	 */
	public static StarshipEntry findByG_U(long groupId, String urlTitle)
		throws com.liferay.starship.exception.NoSuchEntryException {
	 ...
	 * @return the matching starship entry, or <code>null</code> if a matching starship entry could not be found
	 */
	public static StarshipEntry fetchByG_U(long groupId, String urlTitle) {
		return getPersistence().fetchByG_U(groupId, urlTitle);
	}
	 ...
	 * @return the matching starship entry, or <code>null</code> if a matching starship entry could not be found
	 */
	public static StarshipEntry fetchByG_U(
		long groupId, String urlTitle, boolean useFinderCache) {

		return getPersistence().fetchByG_U(groupId, urlTitle, useFinderCache);
	}
	 ...
	 * @return the starship entry that was removed
	 */
	public static StarshipEntry removeByG_U(long groupId, String urlTitle)
		throws com.liferay.starship.exception.NoSuchEntryException {

		return getPersistence().removeByG_U(groupId, urlTitle);
	}
	 ...
	 * @return the number of matching starship entries
	 */
	public static int countByG_U(long groupId, String urlTitle) {
